...
public class OrderServiceTest {
    ...
    public void orderProduct() throws Exception {
        ...
        assertEquals("주문한 상품종류의 수가 정확해야 한다.", 1, getOrder.getOrderItems().size());
    ...
    public void orderItemStockExceed() throws Exception {
        // given
    ...
    public void orderCancel() throws Exception {
        ...
        Book book = createBook("도시 JPA", 5000, 5);
        em.persist(member);
        em.persist(book);
        ...
        assertEquals("주문이 취소된 상품은 재고가 증가해야 한다.", 5, book.getStockQuantity());
    }
